 ...
 */
public class NoticesFeedParser {
    ...
    public static final String DESCRIPTION = "media:attribute";
    ...
    public static final String MEDIAATTRIBUTE = "url";


    public NoticesFeedParser(String urlString) {
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (tagName.equals(DESCRIPTION)) {
                            if(imgUrl.equals(MEDIAATTRIBUTE)) {
                        ...
                        if (tagName.equals(MEDIAATTRIBUTE)) {
                            media = parser.nextText().toString();
                        }
